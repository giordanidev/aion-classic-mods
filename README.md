...
Download and extract the files anywere on your computer. The scripts will detect your install directory automatically. It doesn't need to be in the game directory. Then follow the instructions below.
